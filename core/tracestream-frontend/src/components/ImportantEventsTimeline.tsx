...
/**
 * The viewer's important-events timeline: silence/recovery, rate limiting and
 * span/service/operation-cap overflows, each with a type-specific icon and tone.
 */
export function ImportantEventsTimeline({
  ...
  return (
    <Timeline
      ...
      emptyDescription="Silence periods, rate limiting and span/service/operation-cap overflows will appear here."
