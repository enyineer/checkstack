/**
 * @checkmate-monitor/test-utils-frontend
 *
 ...
 *
 * Import from "@checkmate-monitor/test-utils-frontend/playwright":
 *    ```typescript
 *    import { createPlaywrightConfig, test, expect } from "@checkmate-monitor/test-utils-frontend/playwright";
 *    ```
 */
