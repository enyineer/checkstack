...
- c83d0d1: Register RTL cleanup at root scope so it applies to every frontend test file
...
- 4568dcc: Make the frontend test setup's Happy DOM registration idempotent. A test file
