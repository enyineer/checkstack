...
- b8a00da: Adapt to the access-rule consistency fixes: regenerated docs index for the corrected notification strategy access-rule format (`{ownerPluginId}.strategy.{id}.manage`), and the plugin manager UI now gates install and uninstall actions on the single `pluginManagerAccess.manage` rule.
- Updated dependencies [b8a00da]
- Updated dependencies [b8a00da]
  - @checkstack/backend-api@0.35.3
  - @checkstack/integration-backend@0.7.13
...
- c83d0d1: Regenerate the docs index for the updated status pages and markdown editor pages
