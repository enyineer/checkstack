...
- 88f4333: Include the window and description in maintenance notifications
...
- 43e4484: Fix an N+1 query in the maintenance scheduled job. `getMaintenancesToStart` and
