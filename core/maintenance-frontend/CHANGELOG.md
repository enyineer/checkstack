...
- c38551f: Fix the `#` mention picker's placement, and let it reach descriptions and closed records
...
- 8cad340: Upgrade the maintenance editor's form quality to match the catalog/incident
