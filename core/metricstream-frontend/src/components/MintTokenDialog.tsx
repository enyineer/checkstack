...
/**
 * Mint a source token. The full `ckms_` secret is shown exactly once (the
 * backend keeps only its hash), guarded by `CopyableValue`'s shown-once warning.
 */
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {secret
              ...
              : "A source token authenticates a shipper to push metrics into this stream."}
          </DialogDescription>
        </DialogHeader>
