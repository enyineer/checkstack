...
- bd41130: perf(notification): add composite index on subscription_specs (owner_plugin, target_type_id)
...
- 43e4484: Add a `redirect` option to the shared `postJson` helper. It defaults to
...
- 43e4484: Cut the per-recipient database round-trips in the notification dispatch fan-out.
