...
- 43e4484: Cut the per-event database round-trips in the automation backend's trigger
...
- 43e4484: Batch scoped-db query round-trips on hot write/store paths. Each standalone
