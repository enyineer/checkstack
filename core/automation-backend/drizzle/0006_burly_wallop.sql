...
ALTER TABLE "automation_wake_index" ADD CONSTRAINT "automation_wake_index_wait_lock_id_automation_wait_locks_id_fk" FOREIGN KEY ("wait_lock_id") REFERENCES "public"."automation_wait_locks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
