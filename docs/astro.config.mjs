      ...
      sidebar: [
        { label: "Overview", link: "/" },
        {
          ...
          items: [
            ...
            { label: "Installation", collapsed: false, autogenerate: { directory: "user-guide/installation" } },
            { label: "Concepts",     collapsed: false, autogenerate: { directory: "user-guide/concepts" } },
            { label: "Guides",       collapsed: true,  autogenerate: { directory: "user-guide/guides" } },
            { label: "Reference",    collapsed: true,  autogenerate: { directory: "user-guide/reference" } },
            { label: "Troubleshooting", collapsed: true, autogenerate: { directory: "user-guide/troubleshooting" } },
          ],
        },
        {
          ...
          items: [
            ...
            { label: "Security", collapsed: true, autogenerate: { directory: "developer-guide/security" } },
            { label: "Testing",  collapsed: true, autogenerate: { directory: "developer-guide/testing" } },
            { label: "Tooling",  collapsed: true, autogenerate: { directory: "developer-guide/tooling" } },
            { label: "Examples", collapsed: true, autogenerate: { directory: "developer-guide/examples" } },
          ],
        },
        {
