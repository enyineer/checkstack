...
> [!NOTE]
> Looking for the list of kinds Checkstack ships out of the box and the YAML schemas an operator can use? See [GitOps kind reference](/checkstack/user-guide/reference/gitops-kinds/).
...
[GitOps kind reference](/checkstack/user-guide/reference/gitops-kinds/).
