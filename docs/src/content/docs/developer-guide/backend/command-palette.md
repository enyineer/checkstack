...
description: "The Command Palette provides a unified, keyboard-accessible interface for navigating the application and executing commands. Plugins can contribute both commands (actionable items with optional key…"
---
