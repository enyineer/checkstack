---
title: "Plugin Configuration Storage"
description: "When to use ConfigService for plugin-level settings versus custom Drizzle schemas for user data and entities."
---
...
ConfigService supports schema migrations (see [Versioned Configurations](/checkstack/developer-guide/backend/versioned-configs/)):
