---
title: "Backend Service-to-Service Communication"
description: "Typed RPC clients for plugin-to-plugin calls, with automatic authentication and a consistent developer experience."
---
