---
title: "Common Plugin Guidelines"
description: "Conventions for common packages that share contracts, types, schemas, and access rules between frontend and backend plugins."
---
...
> **Note**: Access rules with `isDefault: true` are automatically synced to the built-in "users" role on startup. See [Backend Plugin Development](/checkstack/developer-guide/backend/plugins/#default-access-rules-and-the-users-role) for details.
...
- [Backend Plugin Development](/checkstack/developer-guide/backend/plugins/) - Implement contracts in backend routers
- [Frontend Plugin Development](/checkstack/developer-guide/frontend/plugins/) - Consume contracts in frontend clients
