---
title: "Frontend Plugin Development Guide"
description: "Scaffold a frontend plugin: React, React Router, ShadCN UI, Vite, and oRPC contract consumption."
---
...
> **Note:** Make sure you have also created the corresponding `-common` and `-backend` packages. See [Common Plugin Guidelines](/checkstack/developer-guide/common/plugins/) and [Backend Plugin Development](/checkstack/developer-guide/backend/plugins/) for details.
...
See [Signals](/checkstack/developer-guide/backend/signals/) for the full signal architecture.
