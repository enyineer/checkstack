---
title: "Contributing to Checkstack"
description: "Thank you for your interest in contributing to Checkstack! This guide will help you get started with contributing plugins or code to the project."
---
...
See [Versioned Data System](/checkstack/developer-guide/backend/versioned-configs/) for details.

## Getting Help

### Documentation

- [Plugin Architecture](/checkstack/developer-guide/architecture/plugin-system/)
- [Monorepo Tooling](/checkstack/developer-guide/getting-started/monorepo-tooling/)
- [Backend Plugins](/checkstack/developer-guide/backend/plugins/)
- [Frontend Plugins](/checkstack/developer-guide/frontend/plugins/)
